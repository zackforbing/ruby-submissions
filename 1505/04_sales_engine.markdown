...
* 3 Spec Harness Failures
* 215 tests, 95.96% coverage
* Spec Harness - 52 seconds
* Very well tested.
...
Assessment Notes: 
* Tests ran in 90 seconds, Spec Harness ran in 52 seconds.
* Could have used some more refactoring, unnecessary accessors, unnecessary readers.
* Good use of enumerables. 
* Spec harness required ruby 2.2.2
...
* 112 tests.
* Spec Harness 2:23.6
* Code showed steady improvement.
* Some opportunities for refactoring based on breaking out code into individual methods.
* Needed unit tests.
...
Assessment Notes:
* 104 tests.
* Spec Harness - 7 Minutes, 13 seconds
* Lack of Unit tests, more sad path tests.
...
Assessment Notes:
* Spec Harness - 77 seconds
* 216 tests, 98.93% coverage, .53 seconds
* Very well refactored code.
* Clean, small methods, for the most part.
* Tests were well written, included sad path tests.
