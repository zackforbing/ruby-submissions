...
github.com/marlomajor/twitter-clone

no production
vast-meadow-8608.herokuapp.com

Notes:
Not on production. Hit errors while trying to push. UI and Design was reverted to a past commit in an attempt to get things to work on production.
UI was untuititve but was bad because of the reverted commits.
...
**2. Code Quality** - 3 - had some service login in views, but no extreme errors.
