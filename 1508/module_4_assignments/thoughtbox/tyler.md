[Simulated Assessment](https://gist.github.com/stevekinney/82831c5b25029415ce8b#file-simulated-assessment-md)
...
Scheduled to re-eval on Thursday - the following things should be looked at and ironed out - will help with taking the final assessment

- Scope ideas to user in all views
- Add edge case integration testing
- Research integration tests and JS with capybara and get skipped test to work
- Optional - Fix Flash notifications
- Get edit title working in JS land
