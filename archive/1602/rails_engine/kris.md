...
Repo: https://github.com/kristindiannefoss/rails_engine

Notes

- Controllers are really clean. Tests have controllers and requests in the same directory. should split those out.j
