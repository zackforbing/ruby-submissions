...
Repo: https://github.com/alirezaandersen/rails_engine.git

Notes:

- Think about what you're testing, what it's job is, and how to know it's doing it's job
- Logic in models should be tested with model tests
- Indexes are for collections. Show is for single items.
